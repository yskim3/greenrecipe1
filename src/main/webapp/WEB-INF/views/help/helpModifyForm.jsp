...
<body>
	...
	<div id="helpWrite" style="width: 400px; margin: 0 auto;">
		...
		<form method="post" action="${contextPath}/help/helpWriteSave" enctype="multipart/form-data" style="text-align: left">
			<input type="text" size="50" name="title" placeholder="1:1 문의 수정 제목을 입력해주세요."> <br><br>
			<textarea name="content" rows="15" cols="50" placeholder="1:1 문의 수정 내용을 입력해주세요."></textarea> <br><br>
		</form>
	</div>
